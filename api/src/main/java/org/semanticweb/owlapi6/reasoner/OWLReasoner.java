 ...
 * ontology. The reasoner will listen to any {@link org.semanticweb.owlapi6.model.OWLOntologyChange}s
 * and respond appropriately to them before answering any queries. If the
 * {@link org.semanticweb.owlapi6.reasoner.BufferingMode} of the reasoner (the answer to
 ...
 * hierarchy has a top node (see org.semanticweb.owlapi6.reasoner.Node#isTopNode()) and a bottom node
 * (see org.semanticweb.owlapi6.reasoner.Node#isBottomNode()). <br>
...
public interface OWLReasoner {
     ...
     *         {@link #isEntailed(org.semanticweb.owlapi6.model.OWLAxiom)} will <em>not</em> throw an
     *         exception of
     ...
     *         calling
     *         {@link #getEquivalentClasses(org.semanticweb.owlapi6.model.OWLClassExpression)} with a
     ...
     * {@link org.semanticweb.owlapi6.model.OWLOntologyManager} that manages the ontologies contained
     * within the reasoner.
     */
    void dispose();
}
